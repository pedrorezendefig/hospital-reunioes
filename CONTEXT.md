...
_Evitar_: enfiar elemento novo entre a gravidade e o prazo (no celular ele empurra o prazo para fora da primeira tela, que é o que a RN-59 existe para evitar), com uma única exceção, nomeada e fechada em 03/09/2026 (issue #559): a **linha de identidade do hospital**, o logo mais "Demanda da Ouvidoria", fica ali de propósito, porque a página é pública e abre a partir de um email, e sem ela quem recebe o link não sabe que a tela é do hospital; qualquer outro elemento continua proibido ali; montar quem manifestou por fora da guarda do caso protegido; deixar a tela reconstruir resumo ou relato que o servidor cortou.
