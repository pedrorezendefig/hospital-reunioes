---
title: Quem entra no Admin
description: Por que o item Admin aparece para tanta gente e por que quase todo mundo só vê uma tela lá dentro.
prd: [731]
draft: false
sidebar:
  order: 20
...
- **Super Admin** abre em **Usuários** e vê as quatro seções da barra.
...
O **Perfil de acesso** é o que decide o que a pessoa alcança no app inteiro, e
a própria tela explica cada um embaixo da opção:

- **Regular:** vê só as reuniões de que participa.
- **Secretária:** marca reuniões e escolhe o facilitador. Não vê pendências nem
  o conteúdo das reuniões. Edita os Dados do Atendimento.
- **Super Admin:** acesso irrestrito, vê e edita tudo.

## Os dois acessos que andam por fora
