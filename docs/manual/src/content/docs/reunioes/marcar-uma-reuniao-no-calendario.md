---
title: Marcar uma reunião no calendário
description: Abrir a data, escolher os participantes e deixar a reunião programada.
prd: [731]
draft: false
...
- **A pessoa que você procura não aparece:** só quem está cadastrado aparece na
  busca. Peça a quem administra a plataforma para cadastrar a pessoa e volte
  aqui.
- **A busca mostra "+N mais. Refine a busca":** a lista mostra dez por vez.
  Escreva mais letras do nome.
- **Você marcou no dia errado:** abra a reunião e corrija a data enquanto ela
  estiver **Programada**. Para desistir, use a lixeira do cartão.
