---
title: Lançar a nota do Google e do Reclame Aqui
description: Como registrar a nota que o hospital tem fora dele, para o relatório da Diretoria mostrar a evolução.
prd: [319]
draft: false
papel: [Ouvidoria]
...
1. Na Ouvidoria, abra o atalho **Nota externa**, que leva a **Nota externa do
   ...
   ![Tela de lançamento das duas notas externas](../../../assets/ouvidoria/nota-externa.png)
