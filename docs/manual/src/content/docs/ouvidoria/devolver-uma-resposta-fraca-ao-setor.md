---
title: Devolver uma resposta fraca ao setor
description: Como mandar o caso de volta para a mesma área quando a resposta não resolve, com motivo escrito.
prd: [318]
draft: false
papel: [Ouvidoria]
sidebar:
...
Quando a área respondeu, mas a resposta não conta o que foi feito, foge do que
você pediu ou não resolve o caso. O caso volta para a mesma área.
