...
Deck de 35 slides para o diretor apresentar o módulo às áreas do hospital. Espelha a
seção Ouvidoria do Manual do usuário (`https://manual-hsm.vercel.app/ouvidoria/`), com os
prints reais de `docs/manual/src/assets/ouvidoria/` e os 7 vídeos de capítulo embutidos. Mostra o sistema na
...
- `img/`: prints das telas que ainda não estão no manual publicado (devolução à Ouvidoria,
  ...
  migrar para `docs/manual/src/assets/ouvidoria/` e a constante `IMG_NOVA` deixa de ser usada.
