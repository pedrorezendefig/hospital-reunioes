...
7. **Vocabulário alinhado ao do app.** "Braço do Hospital" vira **Área do site** (o número fala das páginas do site, não da procura pelo serviço, e não tem vínculo com a taxonomia de Setores). "Objetivo" nunca é chamado de meta. "Origem" é sempre "Origem do público". "Site Oficial" e "Site Novo" viram só "Site". Os guarda-chuvas "Analytics" e "Marketing" e o estado "Em breve" morrem. Definições no `CONTEXT.md`.
