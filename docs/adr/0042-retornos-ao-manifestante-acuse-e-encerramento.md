...
> Emenda em prosa à decisão 5 do ADR 0039 ("o manifestante não recebe email do sistema"). Sem ponteiro `amends` no frontmatter: o 0039 já é emendado pelo 0041 e o lint de ADR aceita um único ponteiro por campo, como o próprio 0037 fez com o 0034.
