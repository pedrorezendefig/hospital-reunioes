...
ONDE VOCÊ ESTÁ
Você está num git worktree próprio, na branch docs/videos-ouvidoria, criado a partir de origin/main. Outros terminais trabalham AO MESMO TEMPO em worktrees irmãos. Antes de qualquer coisa, confira:
