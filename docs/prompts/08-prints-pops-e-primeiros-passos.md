...
ONDE VOCÊ ESTÁ
Você está num git worktree próprio, na branch docs/prints-pops-e-primeiros-passos, criado a partir de origin/main. Outros terminais trabalham AO MESMO TEMPO em worktrees irmãos, contra o MESMO app local e o MESMO banco local. Antes de qualquer coisa, confira:
