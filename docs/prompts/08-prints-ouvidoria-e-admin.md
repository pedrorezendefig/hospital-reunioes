...
Você foi aberto na árvore principal do repositório, /Users/pedrorezende/PedroDev/Hospital, que costuma estar numa branch antiga e é compartilhada com outros terminais abertos AO MESMO TEMPO. Você NÃO trabalha nela. Seu primeiro ato é criar um worktree próprio, a partir de origin/main, e entrar nele:
  ...
  git -C /Users/pedrorezende/PedroDev/Hospital worktree add /Users/pedrorezende/PedroDev/Hospital/.worktrees/prints-ouvidoria-e-admin -b docs/prints-ouvidoria-e-admin origin/main
  cd /Users/pedrorezende/PedroDev/Hospital/.worktrees/prints-ouvidoria-e-admin
Se a branch ou a pasta já existirem de uma tentativa anterior deste mesmo prompt: veja com `gh pr list --head docs/prints-ouvidoria-e-admin --state all` se o PR dela já foi mergeado ou fechado. Se foi, remova os restos (git -C /Users/pedrorezende/PedroDev/Hospital worktree remove --force /Users/pedrorezende/PedroDev/Hospital/.worktrees/prints-ouvidoria-e-admin; git -C /Users/pedrorezende/PedroDev/Hospital branch -D docs/prints-ouvidoria-e-admin) e crie de novo. Se o PR ainda estiver aberto, PARE e reporte: alguém pode estar trabalhando nela.
...
A pasta de trabalho persiste entre os seus comandos, mas confira antes de cada commit:
  ...
  git rev-parse --show-toplevel  (tem que devolver /Users/pedrorezende/PedroDev/Hospital/.worktrees/prints-ouvidoria-e-admin, NUNCA /Users/pedrorezende/PedroDev/Hospital)
