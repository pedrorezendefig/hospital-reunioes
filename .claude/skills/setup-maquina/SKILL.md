...
Saída: uma linha por checagem, com `OK`, `FALTA` ou `AVISO`, e o comando de conserto ao lado. Sai com código 1 se algo obrigatório falta. **O script nunca imprime valor de chave**, só o nome e se está preenchida.
