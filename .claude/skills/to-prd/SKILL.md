---
name: to-prd
description: Transforma o contexto da conversa num PRD e publica como issue no GitHub. Use quando o usuário quiser criar um PRD a partir do que foi discutido.
---
