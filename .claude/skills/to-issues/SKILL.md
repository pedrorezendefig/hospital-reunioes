---
name: to-issues
description: Quebra um plano ou PRD em fatias verticais independentes (tracer bullets) como issues do GitHub, sub-issues do PRD. Use para transformar um plano em tickets.
---
