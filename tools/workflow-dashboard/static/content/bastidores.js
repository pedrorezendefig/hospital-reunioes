...
export const DATA_FLOW = [
  ...
  { n: '3', title: 'O collect.py junta tudo', text: 'Ele lê o GitHub pelo gh, os arquivos do repo (deploys, snapshots, decisões) e o git local, e monta um pacote único.' },
...
export const SOURCES = [
  ...
  { src: 'Produção e deploys (aba Agora / Deploys)', live: false, origin: 'docs/spec/deploy/*.json' },
  { src: 'Mapa da app — rotas, schema, entidades', live: false, origin: 'docs/spec/snapshots/' },
  { src: 'Timeline de releases', live: false, origin: 'docs/spec/CHANGELOG.md' },
...
export const TECH_FACTS = [
  ...
  'Garantia: é só leitura — não há rota de escrita; nada é alterado no repo nem em produção.',
];
