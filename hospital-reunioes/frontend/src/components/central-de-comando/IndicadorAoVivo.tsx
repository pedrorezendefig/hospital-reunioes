...
export function IndicadorAoVivo() {
  ...
  return (
    <div
      aria-live="polite"
      className="inline-flex items-center gap-2 rounded-full border border-border bg-white px-3 py-1.5 text-sm text-text-secondary shadow-premium"
    >
      ...
      <span>
        <strong className="font-semibold tabular-nums text-text">{formatarInteiro(pessoas)}</strong> no site agora
      </span>
    </div>
  );
}
