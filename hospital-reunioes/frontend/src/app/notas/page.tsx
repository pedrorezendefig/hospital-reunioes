...
export default function NotasPage() {
  ...
  // Comando por voz (issue #35; hook compartilhado na #50): o Facilitador dita;
  // o áudio é transcrito e o texto cai EDITÁVEL no corpo — ele revisa e salva
  // manualmente. O áudio fica só em memória (nunca persiste). Falha → aviso +
  // digitação como fallback.
  const { gravando, transcrevendo, iniciarGravacao, pararGravacao, abortarGravacao } =
    useGravacaoVoz({
      getToken: () => token,
      onTexto: (texto) => {
