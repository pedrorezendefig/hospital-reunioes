...
Uso:
  uv run python -m scripts.oneshot.import_consultas_particulares <export.csv>        # insere no banco do .env
  uv run python -m scripts.oneshot.import_consultas_particulares <export.csv> --sql  # imprime INSERTs
"""
