...
CARGOS_MAP: dict[str, CargoInfo] = {
    ...
    "Diretor Administrativo": CargoInfo(
        "Diretor Administrativo", "Diretoria Administrativa", "Administrativa", "diretor"
    ),
    "Diretora Administrativa": CargoInfo(
        "Diretora Administrativa", "Diretoria Administrativa", "Administrativa", "diretor"
    ),
    "Diretor de Recursos Humanos": CargoInfo(
        "Diretor de Recursos Humanos", "Recursos Humanos", "RH e Qualidade", "diretor"
    ),
    "Diretora de Recursos Humanos": CargoInfo(
        "Diretora de Recursos Humanos", "Recursos Humanos", "RH e Qualidade", "diretor"
    ),
    ...
    "Gerente de TI Hospitalar": CargoInfo(
        "Gerente de TI Hospitalar", "Tecnologia da Informação", "Administrativa", "gerente"
    ),
    ...
    "Gerente de Apoio Diagnóstico": CargoInfo(
        "Gerente de Apoio Diagnóstico", "Apoio Diagnóstico", "Assistencial", "gerente"
    ),
    "Gerente de Suprimentos": CargoInfo("Gerente de Suprimentos", "Suprimentos e Compras", "Administrativa", "gerente"),
    "Gerente de Gestão de Pessoas": CargoInfo(
        "Gerente de Gestão de Pessoas", "Recursos Humanos", "RH e Qualidade", "gerente"
    ),
    ...
    "Coordenadora de Cirurgia": CargoInfo(
        "Coordenadora de Cirurgia", "Centro Cirúrgico", "Assistencial", "coordenador"
    ),
    "Coordenador do Pronto Atendimento": CargoInfo(
        "Coordenador do Pronto Atendimento", "Pronto Atendimento", "Assistencial", "coordenador"
    ),
    "Coordenadora do Pronto Atendimento": CargoInfo(
        "Coordenadora do Pronto Atendimento", "Pronto Atendimento", "Assistencial", "coordenador"
    ),
    ...
    "Coordenador de Farmácia": CargoInfo(
        "Coordenador de Farmácia", "Farmácia Hospitalar", "Assistencial", "coordenador"
    ),
    "Coordenadora de Farmácia": CargoInfo(
        "Coordenadora de Farmácia", "Farmácia Hospitalar", "Assistencial", "coordenador"
    ),
    "Coordenador do Laboratório": CargoInfo(
        "Coordenador do Laboratório", "Laboratório Clínico", "Assistencial", "coordenador"
    ),
    "Coordenadora do Laboratório": CargoInfo(
        "Coordenadora do Laboratório", "Laboratório Clínico", "Assistencial", "coordenador"
    ),
    "Coordenador de Sistemas": CargoInfo(
        "Coordenador de Sistemas", "Tecnologia da Informação", "Administrativa", "coordenador"
    ),
    "Coordenadora de Sistemas": CargoInfo(
        "Coordenadora de Sistemas", "Tecnologia da Informação", "Administrativa", "coordenador"
    ),
    "Coordenador de Infraestrutura": CargoInfo(
        "Coordenador de Infraestrutura", "Engenharia Clínica", "Administrativa", "coordenador"
    ),
    "Coordenadora de Infraestrutura": CargoInfo(
        "Coordenadora de Infraestrutura", "Engenharia Clínica", "Administrativa", "coordenador"
    ),
    "Coordenador de Compras": CargoInfo(
        "Coordenador de Compras", "Suprimentos e Compras", "Administrativa", "coordenador"
    ),
    "Coordenadora de Compras": CargoInfo(
        "Coordenadora de Compras", "Suprimentos e Compras", "Administrativa", "coordenador"
    ),
    "Coordenador de Qualidade": CargoInfo(
        "Coordenador de Qualidade", "Qualidade e Segurança", "RH e Qualidade", "coordenador"
    ),
    "Coordenadora de Qualidade": CargoInfo(
        "Coordenadora de Qualidade", "Qualidade e Segurança", "RH e Qualidade", "coordenador"
    ),
    ...
    "Analista de Infraestrutura": CargoInfo(
        "Analista de Infraestrutura", "Tecnologia da Informação", "Administrativa", "coordenador"
    ),
    ...
    "Técnico de Refrigeração": CargoInfo(
        "Técnico de Refrigeração", "Engenharia Clínica", "Administrativa", "coordenador"
    ),
    "Assistente de Compras": CargoInfo(
        "Assistente de Compras", "Suprimentos e Compras", "Administrativa", "coordenador"
    ),
    "Analista de Recrutamento": CargoInfo(
        "Analista de Recrutamento", "Recursos Humanos", "RH e Qualidade", "coordenador"
    ),
...
def get_cargo_info(label: str) -> CargoInfo | None:
